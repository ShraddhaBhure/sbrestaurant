...
using sbrestaurant.services.OrderAPI.Models;
...
namespace sbrestaurant.services.OrderAPI.Controllers
{
    [Route("api/order")]
    [ApiController]
     ...
     //  [Authorize]
        ...
        public async Task<ResponseDto> CreateStripeSession([FromBody] StripeRequestDto stripeRequestDto)
        {
            try
            {
                ...
                Session session = service.Create(options);  //this is stripe Session
